...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'CR4', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '普通的小人物🍚', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://cr4.cn', // 网站地址
